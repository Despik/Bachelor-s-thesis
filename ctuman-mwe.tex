...
\label{seubsec:B}
Dataset B is used for comparison of different heuristics and local search algorithms... same as A2 a konfigurace robota je taky ok, ale layout je jinaci (mensi pocet ramp)
...
The first set of five figures depict comparison between makespan of a schedule created in phase two of the algorithm and the makespan of a the schedule created at the end of the simulation (See the end of Subsection \ref{subsec:scheduleintegration}).

LPT + proposed - only phase to phase 2, 1. compare to optimal makespan, 2. compare insertion real and planned
SPT + proposed - ..., 
LPT + cyclic ramp \& machine? selection
SPT + cyclic ramp \& machine? selection - ...
maybe just random?

\begin{figure*}[h]
\begin{multicols}{2}
    \includegraphics[width=\linewidth]{sc1.jpg}\par 
    \includegraphics[width=\linewidth]{sc1.jpg}\par
    \end{multicols}
\begin{multicols}{2}
    \includegraphics[width=\linewidth]{sc1.jpg}\par 
...
\begin{multicols}{1}
    \includegraphics[width=\linewidth]{sc1.jpg}\par 
    \end{multicols}
\caption{Phase 2 vs optimal, LPT + proposed, SPT + ...}
\end{figure*}
...
\begin{multicols}{2}
    ...
    \includegraphics[width=\linewidth]{sc1.jpg}\par
    \end{multicols}
\caption{Comparison of time difference.}
\end{figure*}
...
\begin{figure}
    \centering
    \includegraphics{}
    \caption{time and reached score + taking the worst score and the best score and compare it in simulation}
    \label{fig:my_label}
\end{figure}
...
\begin{multicols}{2}
    ...
    \includegraphics[width=\linewidth]{sc1.jpg}\par
    \end{multicols}
\caption{Reality worst score vs reality best score}
\end{figure*}
