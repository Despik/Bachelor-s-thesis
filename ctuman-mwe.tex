...
\begin{tabular}{ |c|| c | c |} 
\hline
attribute/schedule & B1 - LPT-LJL & B1 - scheduled resulted from the simulation & B2 - LPT-LJL & B2 - scheduled resulted from the simulation\\ 
\hline
score(hard/soft) & 0/0 & d & h & g \\
\hline
scanners max. buffer size reached & 0 & 10 & 0 & 10\\ 
\hline
average length of idle times & 0 & 0 & 0 & 10\\ 
\hline
\end{tabular}
\end{center}
