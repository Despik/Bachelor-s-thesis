...
This thesis deals with the optimization problem of daily expedition scheduling in an automated warehouse with a focus on robustness and satisfaction of given requirements. The problem includes a truck allocation to expedition ramps and scheduling unloading of predetermined products. We introduce related scheduling problems and their solutions. Method for schedule evaluation is then presented together with heuristic construction method in combination with local search techniques. Combination of these methods is then proposed for construction of the expedition schedule. Finally, the proposed method is implemented in the provided simulation tool and constructed schedule evaluated based on results from the simulation.
